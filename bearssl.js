...
function __asyncjs__jsProvideEncryptedFromNetwork(buf,len) { return Asyncify.handleAsync(async () => { const bytesRead = await Module.provideEncryptedFromNetwork(buf, len); return bytesRead; }); }
function jsWriteEncryptedToNetwork(buf,len) { const bytesWritten = Module.writeEncryptedToNetwork(buf, len); return bytesWritten; }
function jsReceiveDecryptedFromLibrary(buf,len) { Module.jsReceiveDecryptedFromLibrary(buf, len); }
...
var asmLibraryArg = {
  "__asyncjs__jsProvideEncryptedFromNetwork": __asyncjs__jsProvideEncryptedFromNetwork,
  "emscripten_date_now": _emscripten_date_now,
  "emscripten_memcpy_big": _emscripten_memcpy_big,
  "emscripten_resize_heap": _emscripten_resize_heap,
  "fd_write": _fd_write,
  "jsReceiveDecryptedFromLibrary": jsReceiveDecryptedFromLibrary,
  "jsWriteEncryptedToNetwork": jsWriteEncryptedToNetwork
};
...
/** @type {function(...*):?} */
var _initTls = Module["_initTls"] = createExportWrapper("initTls");

/** @type {function(...*):?} */
var _writeData = Module["_writeData"] = createExportWrapper("writeData");

/** @type {function(...*):?} */
var _readData = Module["_readData"] = createExportWrapper("readData");
